...
func (_m *RedisClient) Do(commandName string, args ...interface{}) (interface{}, error) {
	var _ca []interface{}
...
func (_m *RedisClient) Flush() error {
	ret := _m.Called()
...
func (_m *RedisClient) Receive() (interface{}, error) {
	ret := _m.Called()
...
func (_m *RedisClient) Send(commandName string, args ...interface{}) error {
	var _ca []interface{}
	_ca = append(_ca, commandName)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
